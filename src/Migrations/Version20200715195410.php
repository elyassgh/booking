 ...
 */
final class Version20200715195410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hotel ADD image VARCHAR(255) NOT NULL, CHANGE recommended recommended TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hotel DROP image, CHANGE recommended recommended TINYINT(1) DEFAULT \'NULL\'');
    }
}
